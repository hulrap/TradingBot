...
export function OrderBook({
  ...
  useEffect(() => {
    ...
    loadData();
  }, [symbol, chain, dex, selectedGrouping, maxLevels]);
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                max="50"
                value={maxLevels}
                onChange={(e) => setOrderBookData(prev => ({ ...prev }))} // Trigger re-render
                className="w-full"
              />
              <div className="text-xs text-gray-400 mt-1">{maxLevels} levels</div>
            </div>
          </div>
        </div>
      )}
