...
var KillSwitchConfigSchema = z.object({
...
var GlobalKillSwitch = class extends EventEmitter {
  config;
  isTriggered = false;
  isActive = true;
  triggerHistory = [];
...
var PositionSizingConfigSchema = z.object({
...
var RiskManager = class extends EventEmitter {
  killSwitch;
  positionSizing;
  config;
...
export { GlobalKillSwitch, PositionSizingEngine, RiskManager, VERSION, analyzePortfolioHealth, calculateCorrelation, calculateKellyFraction, calculateMaxDrawdown, calculateSharpeRatio, calculateVaR, classifyRiskLevel, createDefaultKillSwitchConfig, createDefaultPositionSizingConfig, createDefaultRiskManagerConfig, createDefaultStressTestScenarios, createRiskAlert };
